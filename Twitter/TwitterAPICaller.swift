...
class TwitterAPICaller: BDBOAuth1SessionManager {
    ...
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "UhXNkjT7WEzPscCWvxEMmA2So", consumerSecret: "ScPumQ5BYukFaZrqm9Y3bebEuiy29XmWPUf1A8ylB0u2QaCiwi")
    var loginSuccess: (() -> ())?
